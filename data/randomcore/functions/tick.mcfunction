...
execute if score random StopRandom matches 1 run function randomcore:random/randomevents/startrandomeffect
...
execute if score start StartKingOfTheHill matches 1 run function randomcore:kingofthehill/startkingorthehilltick
